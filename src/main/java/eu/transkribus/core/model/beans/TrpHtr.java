...
public class TrpHtr {
	...
	public TrpHtr(TrpHtrModel otherHtr) {
		super();
		this.htrId = otherHtr.modelId;
		this.name = otherHtr.name;
		this.description = otherHtr.description;
		this.provider = otherHtr.getProvider();
		this.path = otherHtr.path;
		this.created = otherHtr.created;
		this.language = otherHtr.getLanguage();
		this.baseHtrId = otherHtr.getParentId();
		this.trainJobId = "" + otherHtr.getJobId();
		this.cerString = otherHtr.getCerTrainString();
		this.cerTestString = otherHtr.getCerValString();
		this.charList = otherHtr.getCharSetString();
		this.charSetString = otherHtr.getCharSetString();
		this.bestNetStored = otherHtr.isBestNetStored();
		this.languageModelExists = otherHtr.isLanguageModelExists();
		this.nrOfLines = otherHtr.getTrainNrOfLines();
		this.nrOfWords = otherHtr.getTrainNrOfWords();
		this.params = otherHtr.params;
		this.userName = otherHtr.userName;
		this.userId = otherHtr.userId;
		this.nrOfTrainGtPages = otherHtr.getNrOfTrainGtPages();
		this.nrOfValidationGtPages = otherHtr.getNrOfValidationGtPages();
		this.releaseLevelValue = otherHtr.getReleaseLevel() == null ? 0 : otherHtr.getReleaseLevel();
		this.collectionIdLink = otherHtr.getCollectionIdLink();
		this.delTime = otherHtr.delTime;
		this.cerLog = otherHtr.getCerTrainSeries();
		this.cerTestLog = otherHtr.getCerValSeries();				
	}
