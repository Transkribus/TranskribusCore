...
public class ColorTable {
	...
	public final static List<String> COLORS_LIST = Arrays.asList(COLORS);

	public static String getNewColor(Collection<String> existingColors) {
		String color = "#00000";
		for (String c : COLORS) {
			
			boolean skip = false;
			for (String c1 : existingColors) {
