...
public enum JobImpl {	
	...
	PdfImportJob(JobTask.CreateDocument, JobTask.CreateDocument.getLabel(), "PdfImportJob", null),
	...
	DummyConfigurableJob(JobTask.CreateDocument, "Dummy Configurable Job", "DummyConfigurableJob", null);
