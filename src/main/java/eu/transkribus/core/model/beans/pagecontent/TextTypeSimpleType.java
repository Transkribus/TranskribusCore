...
//    public static int indexOf(TextTypeSimpleType t) {
//    	int i=0;
//    	for (TextTypeSimpleType ts : values()) {
//    		if (t==ts)
//    			return i;
//    		++i;
//    	}
...
//		String[] valuesStr = new String[TextTypeSimpleType.values().length];
//		int i=0;
//		for (TextTypeSimpleType st : TextTypeSimpleType.values()) {
