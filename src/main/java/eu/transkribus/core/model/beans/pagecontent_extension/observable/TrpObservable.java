...
public class TrpObservable extends Observable {
	...
	public static enum EventQueueOrderType {
		/**
		 * First Observer that gets added gets notified first
		 */
		FIRST_IN_FIRST_OUT,
		/**
		 * First Observer that gets added gets notified last
		 */
		FIRST_IN_LAST_OUT;
	}
    ...
    private Vector obs;
	ITrpShapeType source;
	private EventQueueOrderType queueOrder;
	...
	public TrpObservable(ITrpShapeType source, EventQueueOrderType queueOrder) {
//		super();
		obs = new Vector();
		this.source = source;
...
//    }
    ...
    /**
     * The overriden method differs only in the fact, that Observers that were
     * first added are first notified!
     */
    public void notifyObservers(Object arg) {
        ...
        if (queueOrder == EventQueueOrderType.FIRST_IN_LAST_OUT) {
	...
	public ITrpShapeType getSource() { return (ITrpShapeType) source; }
