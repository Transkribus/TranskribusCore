...
public final class OrderedProperties implements Serializable {
	...
	public void storeSimple(File outFile) throws IOException {
		storeSimple(this, outFile);
	}

	public void storeSimple(File outFile, String keyValueDelimiter) throws IOException {
		storeSimple(this, outFile, keyValueDelimiter);
	}
	
	public static void storeSimple(OrderedProperties p, File outFile) throws IOException {
		storeSimple(p, outFile, " ");
	}
	
	/**
	 * @author jkloe
	 */
	public static void storeSimple(OrderedProperties p, File outFile, String keyValueDelimiter) throws IOException {
